...
if($post)
{
    ...
    $subject = 'Заявка в на подключение';
...
// Check email
    ...
    if(!$comment)
    {
        $error .= 'Пожалуйста заполните поле "Комментарий".<br />';//mb_convert_encoding ('Пожалуйста заполните поле "Комментарий".<br />' ,"UTF-8", "Windows-1251");
    }
...
Контактное лицо: ".$_POST['name']//mb_convert_encoding ($_POST['name'] ,"Windows-1251", "UTF-8"  )
            ." \r\n
...
E-mail: ".$_POST['email']//mb_convert_encoding ($_POST['email'] ,"Windows-1251", "UTF-8"  )
            ."\r\n

Интересующие услуги: ".implode(', ', $uslugi)//  mb_convert_encoding (implode(', ', $uslugi),"Windows-1251", "UTF-8"  )
            ."\r\n

Комментарий: ".$_POST['content'];//mb_convert_encoding ($_POST['content'] ,"Windows-1251", "UTF-8"  );
