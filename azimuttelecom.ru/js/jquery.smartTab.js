    ...
    $.fn.smartTab = function(options) {
        ...
        return this.each(function() {
                ...
                function showTab(){
					...
					$($(selTab, obj).attr("href"), obj).find('div.caption').css({left:-1000});
                    ...
                    if(options.transitionEffect == 'slide'){
                      ...
                      $($(selTab, obj).attr("href"), obj).fadeIn("slow", function(){
																				   //$(this).find('div.caption').animate({bottom:0},800, "easeOutExpo"  );
																				  // $(this).hide();  ////// for better work:hide prev image (display:none) 
																				   //showTab();
																				   
																				   } );
					  $($(selTab, obj).attr("href"), obj).find('div.caption').animate({left:0},800, "easeOutExpo"  );
                ...
                function hideTab(idx){
                    ...
                    if(options.transitionEffect == 'slide'){
					  ...
					  $($(selTab, obj).attr("href"), obj).find('div.caption').animate({left:-1000},800, "easeOutQuint"  );
						
                      $($(selTab, obj).attr("href"), obj).fadeOut("slow", function(){
